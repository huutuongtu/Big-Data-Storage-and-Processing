...
schema = StructType([
    ...
    StructField("change", StructType([
        ...
        StructField("change_percent_five_min", DoubleType(), True),
        StructField("change_percent_fifteen_min", DoubleType(), True),
        StructField("change_percent_one_hour", DoubleType(), True)
    ]), True)
])
